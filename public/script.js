document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        // Validate on input (clear errors as user types)
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'b3385d96-8b34-4225-b1dc-d52f64f7439d',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'b3385d96-8b34-4225-b1dc-d52f64f7439d';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b3385d96-8b34-4225-b1dc-d52f64f7439d';
